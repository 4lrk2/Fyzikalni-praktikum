...
class DropsFilter:
    ...
    def find_drops_inversion_frame(self, drops_data: DropsData, diff_frame_count=5, min_frame=5) -> Tuple[int, DropsData]:
    ...
    def analyze_drop(self, 
        ...
        interval1 = np.arange(inversion_frame - self.frames_from_inversion_offset, inversion_frame - self.frames_from_inversion_offset - 10, -1)
        interval2 = np.arange(inversion_frame + self.frames_from_inversion_offset, inversion_frame + self.frames_from_inversion_offset + 10, 1)
        y1 = y[interval1]
        y2 = y[interval2]
        x1 = x[interval1]
        x2 = x[interval2]
